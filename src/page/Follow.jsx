...
function Follow() {
  return (
    <Layout>
      <Row>
        <Col xs={6} className="line-dv">
          <ul role="list" class="px-20 divide-y divide-gray-100">
            Đang theo dõi
            <li class="flex zoom-2 justify-between gap-x-6 py-3">
              ...
              <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                ...
                <p class="mt-1 text-xs leading-5 text-gray-500">Add friend</p>
              </div>
            </li>
            <li class="flex zoom-2 justify-between gap-x-6 py-3">
              <div class="flex min-w-0 gap-x-4">
        ...
        <Col xs={6}>
          <ul role="list" class="px-20 divide-y divide-gray-100">
            Người theo dõi
            <li class="zoom-2 flex justify-between gap-x-6 py-3">
              <div class="flex min-w-0 gap-x-4">
                <img
                  class="h-12 w-12 flex-none rounded-full bg-gray-50"
                  src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
